...
const project = new awscdk.AwsCdkConstructLibrary({
  ...
  name: 'projen-apigateway-construct',
  description: 'cdk apigateway constrctn',
  repositoryUrl: 'https://github.com/vaughngit/projen-apigateway-construct.git',
  docgen: true,
  license: 'Apache-2.0',
  keywords: ['apigateway', 'cdk', 'AWS', 'lambda'],
  bundledDeps: [
  ...
  deps: [
    'vt-lambda-construct',
  ], /* Project Runtime dependencies of this module. */
  devDeps: [
    'esbuild',
